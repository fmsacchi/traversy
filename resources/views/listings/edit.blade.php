    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <img class="w-48 mr-6 mb-6" src="{{$listing->logo ? asset('storage/' . $listing->logo) : asset('/images/hero.jpeg')}}"
                    alt="" />
            ...
            <div class="mb-6">
                <button class="bg-red-700 text-white rounded py-2 px-4 hover:bg-black">
                    Update Gig
                </button>
